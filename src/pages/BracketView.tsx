...
import { ChevronLeft, RefreshCw, Printer, Download } from 'lucide-react';

const BracketView = () => {
  const { categoryId } = useParams<{ categoryId: string }>();
  const [viewMode, setViewMode] = useState<'bracket' | 'pools'>('bracket');
  
  // Mock data for demonstration
  const categoryData = {
    id: categoryId,
    name: 'Minimes -46kg',
    type: 'Tableau à double repêchage',
    competitors: 16,
    status: 'En cours',
  };
    ...
    rounds: [
      {
        ...
        matches: [
          { id: 1, competitor1: 'Lucas Martin', competitor2: 'Thomas Dubois', score1: 10, score2: 0, winner: 'Lucas Martin', status: 'completed' },
          { id: 2, competitor1: 'Alexandre Petit', competitor2: 'Nicolas Leroy', score1: 0, score2: 7, winner: 'Nicolas Leroy', status: 'completed' },
          { id: 3, competitor1: 'Maxime Dupont', competitor2: 'Antoine Moreau', score1: 10, score2: 0, winner: 'Maxime Dupont', status: 'completed' },
          { id: 4, competitor1: 'Julien Bernard', competitor2: 'Romain Fournier', score1: 0, score2: 10, winner: 'Romain Fournier', status: 'completed' },
        ]
      },
      {
        name: 'Demi-finales',
        matches: [
          { id: 5, competitor1: 'Lucas Martin', competitor2: 'Nicolas Leroy', score1: 7, score2: 0, winner: 'Lucas Martin', status: 'completed' },
          { id: 6, competitor1: 'Maxime Dupont', competitor2: 'Romain Fournier', score1: 0, score2: 10, winner: 'Romain Fournier', status: 'completed' },
        ]
      },
      {
        name: 'Finale',
        matches: [
          { id: 7, competitor1: 'Lucas Martin', competitor2: 'Romain Fournier', score1: null, score2: null, winner: null, status: 'scheduled' },
        ]
      }
    ],
    repechage: [
      {
        name: 'Repêchage',
        matches: [
          { id: 8, competitor1: 'Thomas Dubois', competitor2: 'Antoine Moreau', score1: 10, score2: 0, winner: 'Thomas Dubois', status: 'completed' },
          { id: 9, competitor1: 'Alexandre Petit', competitor2: 'Julien Bernard', score1: 0, score2: 7, winner: 'Julien Bernard', status: 'completed' },
        ]
      },
      {
        name: 'Bronze',
        matches: [
          { id: 10, competitor1: 'Thomas Dubois', competitor2: 'Nicolas Leroy', score1: null, score2: null, winner: null, status: 'scheduled' },
          { id: 11, competitor1: 'Julien Bernard', competitor2: 'Maxime Dupont', score1: null, score2: null, winner: null, status: 'scheduled' },
        ]
      }
    ]
  };
    ...
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4 sm:gap-0">
        <div>
          ...
          <h1 className="text-2xl font-semibold text-gray-900">{categoryData.name}</h1>
          <p className="text-sm text-gray-500">{categoryData.type} • {categoryData.competitors} compétiteurs • {categoryData.status}</p>
        </div>
